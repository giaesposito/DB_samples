...
CustomKeywords.'com.katalon.plugin.keyword.connection.DatabaseKeywords.executeUpdate'(globalConnection,
	"DELETE FROM  dbo.curaHealthcare WHERE age < 18")
...
CustomKeywords.'com.katalon.plugin.keyword.connection.ResultSetKeywords.exportToCSV'(userData, '/Users/gia/Katalon Studio/Katalon Demo/Data Files/Cura Comments - Sheet1.csv')